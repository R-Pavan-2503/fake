...
const Header = () => {
  ...
  return (
    <header className="flex overflow-hidden flex-wrap gap-10 px-20 py-7 mr-3 max-w-full text-3xl text-center text-black bg-white rounded-3xl shadow-[0px_-8px_26px_rgba(0,122,255,0.46)] w-[1534px] max-md:px-5 max-md:mr-2.5">
